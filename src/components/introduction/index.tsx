...
const Introduction = () => {
  return (
    <div className="introduction text-primary">
      <NavMenu />
      ...
      <div>
        <Button text="Say Hello" onClick={() => {}}></Button>
      </div>
      <div className="links">
        <a
      ...
      <p className='text-gray'>Reach me at <span className='text-link'>leeyoongti@gmail.com</span>{' '}
        or download{' '}
        <a
          className="text-link"
          href="/Felix.pdf"
