...
export const WORK_ITEMS: IWorkItem[] = [
  ...
  },
  {
    ...
    detailList: [
      ...
      'Accomplish 200,000 newly registered users and 800K EKYC users in 1 day after shipping E-tunai program',
      'Integrate payment page with Lazada that generates 8 million revenue during 11/11 big sale',
